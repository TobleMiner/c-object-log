...
static inline void multiring_advance(multiring_t *multiring, multiring_ptr_t *ptr,
				     uint16_t count) {
...
static inline void multiring_write(multiring_t *multiring, const void *data, uint16_t len) {
...
static inline void multiring_read(multiring_t *multiring, void *data, uint16_t len) {
	uint8_t *data8 = data;
...
static inline uint16_t multiring_num_wraps(multiring_t *multiring,
					   uint16_t len) {
...
static inline void multiring_memset(multiring_t *multiring, uint8_t val,
				     uint16_t len) {
	while (len) {
		uint16_t write_size = len;
		uint16_t space_avail =
...
static inline uint16_t multiring_byte_delta(multiring_t *multiring,
